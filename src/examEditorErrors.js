...
const EXERCISE_EMPTY_TESTCASE =
  'Questo esercizio contiene almeno un test case vuoto'
const EXERCISE_NO_CATEGORY = 'Questo esercizio non appartiene a una categoria'

const QUESTION_NO_TEXT = 'Questa domanda non ha un testo'
const QUESTION_NO_CATEGORY = 'Questa domanda non appartiene a una categoria'
const QUESTION_NO_RIGHT_ANSWER = 'Questa domanda non ha risposte corrette'
const QUESTION_EMPTY_ANSWER =
  'Questa domanda contiene almeno una risposta senza testo'

const CATEGORY_NEGATIVE_AMOUNT =
  'Il campo quantità di questa categoria contiene un numero negativo'
const CATEGORY_NO_NAME = 'Questa categoria non ha nome'

const QUESTION_CATEGORY_AMOUNT_TOO_HIGH =
...
const EXERCISE_CATEGORY_AMOUNT_TOO_HIGH =
